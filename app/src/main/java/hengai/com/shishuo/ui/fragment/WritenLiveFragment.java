...
public class WritenLiveFragment extends BaseFragment {
    @Override
    ...
    protected View onCreatContentView() {
        View root = View.inflate(getContext(), R.layout.fragment_writen_live, null);
        RefreshLayout refreshLayout = (RefreshLayout) root.findViewById(R.id.refreshLayout);
        ListView listView = (ListView) root.findViewById(R.id.lv_writen_live);
    ...
    private class MyAdapte extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            InterViewLiveFragement.ViewHolder viewHolder = null;

            if (convertView == null) {
                convertView = LayoutInflater.from(getContext()).inflate(R.layout.item_listview_live, null);
                viewHolder = new InterViewLiveFragement.ViewHolder(convertView);
                convertView.setTag(viewHolder);
            } else {
                viewHolder = (InterViewLiveFragement.ViewHolder) convertView.getTag();
            }
