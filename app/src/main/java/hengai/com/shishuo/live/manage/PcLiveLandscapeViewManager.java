package hengai.com.shishuo.live.manage;
...
import hengai.com.shishuo.live.popup.AnnounceLandscapePopup;
import hengai.com.shishuo.live.popup.BasePopupWindow;
import hengai.com.shishuo.live.popup.DefinitionPopup;
import hengai.com.shishuo.live.popup.LiveSourcePcLandscapePopup;
...
public class PcLiveLandscapeViewManager {
    ...
    @InjectView(R.id.tv_phone_live_user_count)
    TextView mUserCount;

    @InjectView(R.id.ll_land_live_left_layout)
    LinearLayout mLeftLayout;

    @InjectView(R.id.tv_phone_live_announce)
    TextView mLiveAnnounce;

    @InjectView(R.id.iv_phone_live_barrage)
    ImageView mBarrageControl;

    @InjectView(R.id.iv_phone_live_close)
    ...
    // TODO
    @InjectView(R.id.id_land_live_push_mask_layer)
    FrameLayout mMaskLayer;

    @InjectView(R.id.rl_top_layout)
    RelativeLayout mTopLayout;


    @InjectView(R.id.iv_land_live_change_source)
    ImageView mChangeSource;

    @InjectView(R.id.iv_land_live_change_audio_video)
    ImageView ivChangeAudioVideo;


    @InjectView(R.id.id_push_chat_send)
    Button idPushChatSend;

    @InjectView(R.id.id_push_bottom)
    LinearLayout idPushBottom;

    @InjectView(R.id.tv_phone_live_title)
    TextView mTitle;


    @InjectView(R.id.ll_pc_land_right_layout)
    LinearLayout mRightLayout;

    @InjectView(R.id.iv_announce_new)
    ImageView ivAnnounceNew;

    @InjectView(R.id.iv_land_live_video_rtc)
    ImageView rtcView;
