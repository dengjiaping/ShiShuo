...
import hengai.com.shishuo.live.popup.AnnouncePcPortaritPopup;
import hengai.com.shishuo.live.popup.BasePopupWindow;
import hengai.com.shishuo.live.popup.LiveSourcePcPortraitPopup;
...
public class PcLivePortraitViewManager {
    ...
    //------------------顶部布局---------------------------
    @InjectView(R.id.rl_portrait_live_top_layout)
    RelativeLayout mTopLayout;
    @InjectView(R.id.iv_portrait_live_close)
    ImageView ivPortraitLiveClose;
    @InjectView(R.id.tv_portrait_live_title)
    TextView mTitle;
    @InjectView(R.id.tv_portrait_live_announce) //TODO 看看顶部导航栏是不是可以共用的
            TextView tvPortraitLiveAnnounce;
    @InjectView(R.id.iv_portrait_announce_new)
    ImageView ivAnnounceNew;

    //------------------右侧布局---------------------------
    @InjectView(R.id.ll_portrait_live_right_layout)
    LinearLayout mRightLayout;
    @InjectView(R.id.iv_portrait_live_change_audio_video)
    ImageView ivChangeAudioVideo;
    @InjectView(R.id.iv_portrait_live_barrage)
    ImageView ivPortraitLiveBarrage;
    @InjectView(R.id.iv_portrait_live_full)
    ImageView ivFullScreen;

    //------------------左侧布局---------------------------
    @InjectView(R.id.ll_portrait_live_left_layout)
    LinearLayout mLeftLayout;
    @InjectView(R.id.iv_portrait_live_rtc)
    ImageView rtcView;
    @InjectView(R.id.iv_portrait_live_change_line)
    ImageView ivPortraitLiveChangeLine;

    @InjectView(R.id.tv_portrait_live_user_count)
