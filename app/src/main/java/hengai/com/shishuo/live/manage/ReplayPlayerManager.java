...
import hengai.com.shishuo.live.activity.ReplayActivity;
import hengai.com.shishuo.utils.TimeUtil;
...
public class ReplayPlayerManager {
    ...
    @InjectView(R.id.replay_title)
    TextView mTitle;

    @InjectView(R.id.replay_play_control_bottom)
    LinearLayout playControlBottom;

    @InjectView(R.id.replay_play_control_top)
    LinearLayout playControlTop;

    @InjectView(R.id.replay_play_control_top_left)
    LinearLayout playControlTopLeftLayout;

    @InjectView(R.id.replay_current_time)
    TextView currentTime;

    @InjectView(R.id.replay_duration)
    TextView durationTextView;

    @InjectView(R.id.replay_sign)
    TextView replaySign;

    @InjectView(R.id.replay_back)
    ImageView back;

    @InjectView(R.id.replay_play_icon)
    ImageView playIcon;

    @InjectView(R.id.replay_progressbar)
    SeekBar playSeekBar;

    @InjectView(R.id.replay_speed)
    Button playSpeed;

    @InjectView(R.id.replay_full_screen)
